...
llm = BedrockChat(model_id="anthropic.claude-v2:1", client=bedrock, model_kwargs={"max_tokens": 512})
...
def get_vector_store(text_chunks):
    ...
    try:
        ...
        vector_store = FAISS.from_texts(text_chunks, embedding=bedrock_embeddings)
...
def user_input(user_question):
    ...
    try:
        new_db = FAISS.load_local(os.path.join(folder_path, "faiss_index"), bedrock_embeddings, allow_dangerous_deserialization=True)
